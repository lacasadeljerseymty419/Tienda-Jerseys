    ...
    products.forEach(p => {
        ...
        if (images.length > 1) {
            carouselControlsHtml = `
                <button type="button" class="carousel-prev-btn absolute left-1.5 sm:left-2 top-1/2 -translate-y-1/2 w-7 h-7 sm:w-8 sm:h-8 bg-black/70 hover:bg-black backdrop-blur-md rounded-full flex items-center justify-center shadow-lg hover:scale-105 transition-all text-white z-10 opacity-100 md:opacity-0 md:group-hover:opacity-100">
                ...
                <div class="absolute bottom-2 left-1/2 -translate-x-1/2 flex gap-1 z-10 bg-black/60 backdrop-blur-xs px-2 py-1 rounded-full opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity">
